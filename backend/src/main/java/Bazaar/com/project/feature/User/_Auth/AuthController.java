package Bazaar.com.project.feature.User._Auth;
...
import Bazaar.com.project.feature.User._Auth.dto.LoginRequest;
...
public class AuthController {
        ...
        public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody LoginRequest request) {
                ...
                if (refresh_token == null) {
                        throw new FuncErrorException("Failed to generate refresh token");
                }
