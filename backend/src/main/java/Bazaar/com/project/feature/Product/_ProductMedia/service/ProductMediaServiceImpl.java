...
import Bazaar.com.project.feature.Product._ProductMedia.repository.ProductImageRepository;
...
public class ProductMediaServiceImpl implements ProductMediaService {
        ...
        @Override
        @Transactional
        public ProductMediaResponse uploadThumbnail(@NonNull UUID productId, MultipartFile file) {
        ...
        @Override
        @Transactional
        public ProductMediaResponse uploadGallery(@NonNull UUID productId, List<MultipartFile> files) {
        ...
        @Override
        @Transactional
        public ProductMediaResponse updateThumbnail(@NonNull UUID productId, MultipartFile file) {
                final Product product = productRepository.findById(productId)
                                .orElseThrow(() -> new IdInvalidException("Product not found"));
        ...
        @Override
        @Transactional
        public ProductMediaResponse updateGalleryImage(@NonNull UUID productId, @NonNull UUID imageId,
                        MultipartFile file) {
                final Product product = productRepository.findById(productId)
                                .orElseThrow(() -> new IdInvalidException("Product not found"));
        ...
        @Override
        @Transactional
        public ProductMediaResponse deleteThumbnail(@NonNull UUID productId) {
                final Product product = productRepository.findById(productId)
                                .orElseThrow(() -> new IdInvalidException("Product not found"));
        ...
        @Override
        @Transactional
        public ProductMediaResponse deleteGalleryImage(@NonNull UUID productId, @NonNull UUID imageId) {
                // 1) Load product
                final Product product = productRepository.findById(productId)
                                .orElseThrow(() -> new IdInvalidException("Product not found"));
                ...
                // fine:
                if (ordered == null) {
                        throw new FuncErrorException("Order list of product images error");
                }
